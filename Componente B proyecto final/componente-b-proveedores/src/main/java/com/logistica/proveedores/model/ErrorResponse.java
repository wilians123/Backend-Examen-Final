...
public class ErrorResponse implements Serializable {
  ...
  */
  @Valid 
  @Schema(name = "timestamp", example = "2024-11-04T10:30Z", required = false)
  ...
  */
  ...
  @Schema(name = "message", example = "El RFC del proveedor ya existe", required = false)
  ...
  */
  ...
  @Schema(name = "path", example = "/api/v1/proveedores", required = false)
